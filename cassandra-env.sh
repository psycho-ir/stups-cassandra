...
JVM_OPTS="$JVM_OPTS -Djava.rmi.server.hostname=$LISTEN_ADDRESS"
#
# see
...
JVM_OPTS="$JVM_OPTS -javaagent:/agents/appdynamics-jvm/javaagent.jar -Dappdynamics.agent.uniqueHostId=$(cat /agents/appdynamics-jvm/uniqueHostId)"
